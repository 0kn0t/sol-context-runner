...
- **tokenHolded** (state variable) [lib/openzeppelin-contracts-upgradeable/lib/openzeppelin-contracts/contracts/token/ERC20/IERC20.sol/interface_IERC20.md]
...
```
┌─ [0] ⚙️ FUNCTION: TokenHolder.withdraw(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
