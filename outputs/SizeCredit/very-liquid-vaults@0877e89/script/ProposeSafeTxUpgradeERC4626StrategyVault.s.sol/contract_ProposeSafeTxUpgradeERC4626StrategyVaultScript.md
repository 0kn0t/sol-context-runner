...
- **Name**: ProposeSafeTxUpgradeERC4626StrategyVaultScript
- **Type**: Contract
- **Path**: script/ProposeSafeTxUpgradeERC4626StrategyVault.s.sol
...
- **Details**: [function_getMainnetStrategies.md](./function_getMainnetStrategies.md)
...
- **Details**: [function_getBaseStrategies.md](./function_getBaseStrategies.md)
