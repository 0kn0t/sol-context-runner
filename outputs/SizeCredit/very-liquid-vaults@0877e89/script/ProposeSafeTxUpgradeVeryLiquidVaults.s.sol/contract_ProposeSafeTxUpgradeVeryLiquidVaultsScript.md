...
- **Name**: ProposeSafeTxUpgradeVeryLiquidVaultsScript
- **Type**: Contract
- **Path**: script/ProposeSafeTxUpgradeVeryLiquidVaults.s.sol
...
- **Details**: [function_getMainnetVeryLiquidVaults.md](./function_getMainnetVeryLiquidVaults.md)
...
- **Details**: [function_getBaseVeryLiquidVaults.md](./function_getBaseVeryLiquidVaults.md)
