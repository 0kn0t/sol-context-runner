...
- **Name**: TimelockControllerEnumerablesScript
- **Type**: Contract
- **Path**: script/TimelockControllerEnumerables.s.sol
...
### vaultManagerMultisig

```solidity
address internal vaultManagerMultisig
```
...
### deploy(uint256,address[],address[],address)

- **Signature**: `deploy(uint256,address[],address[],address)`
- **Visibility**: public
- **Source Range**: 2333:274:139
- **Details**: [function_deploy_uint256_address[]_address[]_address.md](./function_deploy_uint256_address[]_address[]_address.md)
