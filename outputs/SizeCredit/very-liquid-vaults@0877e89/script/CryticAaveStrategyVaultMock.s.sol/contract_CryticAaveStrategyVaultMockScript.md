...
- **Name**: CryticAaveStrategyVaultMockScript
- **Type**: Contract
- **Path**: script/CryticAaveStrategyVaultMock.s.sol
...
- **Details**: [function_deploy_contract_Auth_contract_IERC20Metadata_uint256_contract_PoolMock.md](./function_deploy_contract_Auth_contract_IERC20Metadata_uint256_contract_PoolMock.md)
