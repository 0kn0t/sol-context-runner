...
- **Name**: CashStrategyVaultScript
- **Type**: Contract
- **Path**: script/CashStrategyVault.s.sol
...
- **Details**: [function_deploy_contract_Auth_contract_IERC20Metadata_uint256.md](./function_deploy_contract_Auth_contract_IERC20Metadata_uint256.md)
