...
- **Name**: ConfigureAuthRolesScript
- **Type**: Contract
- **Path**: script/ConfigureAuthRoles.s.sol
...
```solidity
TimelockControllerEnumerable internal timelockController_DEFAULT_ADMIN_ROLE
```

**TimelockControllerEnumerable**: [lib/openzeppelin-community-contracts/contracts/governance/TimelockControllerEnumerable.sol/contract_TimelockControllerEnumerable.md]

### timelockController_VAULT_MANAGER_ROLE

```solidity
TimelockControllerEnumerable internal timelockController_VAULT_MANAGER_ROLE
```
