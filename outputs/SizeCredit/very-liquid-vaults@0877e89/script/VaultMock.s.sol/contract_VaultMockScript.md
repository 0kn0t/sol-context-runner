...
- **Name**: VaultMockScript
- **Type**: Contract
- **Path**: script/VaultMock.s.sol
...
- **Details**: [function_deploy_address_contract_IERC20_string_string.md](./function_deploy_address_contract_IERC20_string_string.md)
