...
- **Name**: CryticVeryLiquidVaultMockScript
- **Type**: Contract
- **Path**: script/CryticVeryLiquidVaultMock.s.sol
...
- **Details**: [function_deploy_contract_Auth_contract_IERC20Metadata_uint256_contract_IVault[].md](./function_deploy_contract_Auth_contract_IERC20Metadata_uint256_contract_IVault[].md)
