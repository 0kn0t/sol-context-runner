...
- **Name**: VeryLiquidVaultScript
- **Type**: Contract
- **Path**: script/VeryLiquidVault.s.sol
...
### veryLiquidVaultFirstDepositAmount

```solidity
uint256 internal veryLiquidVaultFirstDepositAmount
```

### strategies

```solidity
IVault[] internal strategies
```
...
- **Details**: [function_deploy_string_contract_Auth_contract_IERC20Metadata_uint256_contract_IVault[].md](./function_deploy_string_contract_Auth_contract_IERC20Metadata_uint256_contract_IVault[].md)
