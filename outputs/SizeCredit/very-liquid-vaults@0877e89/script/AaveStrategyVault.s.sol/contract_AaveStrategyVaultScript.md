...
- **Name**: AaveStrategyVaultScript
- **Type**: Contract
- **Path**: script/AaveStrategyVault.s.sol
...
- **Details**: [function_deploy_contract_Auth_contract_IERC20Metadata_uint256_contract_IPool.md](./function_deploy_contract_Auth_contract_IERC20Metadata_uint256_contract_IPool.md)
