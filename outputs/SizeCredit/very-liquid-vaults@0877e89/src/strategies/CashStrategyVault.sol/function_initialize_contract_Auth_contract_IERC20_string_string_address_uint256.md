...
┌─ [0] ⚙️ FUNCTION: BaseVault.initialize(contract Auth,contract IERC20,string,string,address,uint256) (NodeID: 0)
  ...
  │   👁️  Def: private
  │ ├─ [2] ⚙️ FUNCTION: BaseVault.maxDeposit(address) (NodeID: 76)
  │ │   💬 Args: [receiver]
  │ │   👁️  Def: public
  │ │ ├─ [3] ⚙️ FUNCTION: BaseVault._pausedOrAuthPaused() (NodeID: 77)
  │ │ │   💬 Args: [no args]
  │ │ │   👁️  Def: private
  │ │ │ ├─ [4] ⚙️ FUNCTION: BaseVault.auth() (NodeID: 78)
  │ │ │ │   💬 Args: [no args]
  │ │ │ │   👁️  Def: public
  │ │ │ │ └─ [5] ⚙️ FUNCTION: BaseVault._getBaseVaultStorage() (NodeID: 79)
  │ │ │ │     💬 Args: [no args]
  │ │ │ │     👁️  Def: private
  │ │ │ └─ [4] ⚙️ FUNCTION: PausableUpgradeable.paused() (NodeID: 80)
  │ │ │     💬 Args: [no args]
  │ │ │     👁️  Def: public
  │ │ │   └─ [5] ⚙️ FUNCTION: PausableUpgradeable._getPausableStorage() (NodeID: 81)
  │ │ │       💬 Args: [no args]
  │ │ │       👁️  Def: private
  │ │ ├─ [3] ⚙️ FUNCTION: BaseVault._totalAssetsCap() (NodeID: 82)
  │ │ │   💬 Args: [no args]
  │ │ │   👁️  Def: private
  │ │ │ └─ [4] ⚙️ FUNCTION: BaseVault._getBaseVaultStorage() (NodeID: 83)
  │ │ │     💬 Args: [no args]
  │ │ │     👁️  Def: private
  │ │ ├─ [3] ⚙️ FUNCTION: ERC4626Upgradeable.maxDeposit(address) (NodeID: 84)
  │ │ │   💬 Args: [receiver]
  │ │ │   👁️  Def: public
  │ │ └─ [3] ⚙️ FUNCTION: BaseVault._maxDeposit() (NodeID: 85)
  │ │     💬 Args: [no args]
  │ │     👁️  Def: private
  │ │   └─ [4] ⚙️ FUNCTION: Math.saturatingSub(uint256,uint256) (NodeID: 86)
  │ │       💬 Args: [_totalAssetsCap(), totalAssets()]
  │ │       👁️  Def: internal
  │ │     ├─ [5] ⚙️ FUNCTION: BaseVault._totalAssetsCap() (NodeID: 89)
  │ │     │   💬 Args: [no args]
  │ │     │   👁️  Def: private
  │ │     │ └─ [6] ⚙️ FUNCTION: BaseVault._getBaseVaultStorage() (NodeID: 90)
  │ │     │     💬 Args: [no args]
  │ │     │     👁️  Def: private
  │ │     ├─ [5] ⚙️ FUNCTION: ERC4626Upgradeable.totalAssets() (NodeID: 91)
  │ │     │   💬 Args: [no args]
  │ │     │   👁️  Def: public
  │ │     │ └─ [6] ⚙️ FUNCTION: ERC4626Upgradeable.asset() (NodeID: 92)
  │ │     │     💬 Args: [no args]
  │ │     │     👁️  Def: public
  │ │     │   └─ [7] ⚙️ FUNCTION: ERC4626Upgradeable._getERC4626Storage() (NodeID: 93)
  │ │     │       💬 Args: [no args]
  │ │     │       👁️  Def: private
  │ │     └─ [5] ⚙️ FUNCTION: Math.trySub(uint256,uint256) (NodeID: 87)
  │ │         💬 Args: [a, b]
  │ │         👁️  Def: internal
  │ │       └─ [6] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 88)
  │ │           💬 Args: [success]
  │ │           👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: ERC4626Upgradeable.previewDeposit(uint256) (NodeID: 94)
  │ │   💬 Args: [firstDepositAmount_]
  │ │   👁️  Def: public
  │ │ └─ [3] ⚙️ FUNCTION: ERC4626Upgradeable._convertToShares(uint256,enum Math.Rounding) (NodeID: 95)
  │ │     💬 Args: [assets, Math.Rounding.Floor]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256,enum Math.Rounding) (NodeID: 96)
  │ │       💬 Args: [assets, totalSupply() + (10 ** _decimalsOffset()), totalAssets() + 1, rounding]
  │ │       👁️  Def: internal
  │ │     ├─ [5] ⚙️ FUNCTION: ERC4626Upgradeable._decimalsOffset() (NodeID: 104)
  │ │     │   💬 Args: [no args]
  │ │     │   👁️  Def: internal
  │ │     ├─ [5] ⚙️ FUNCTION: ERC20Upgradeable.totalSupply() (NodeID: 105)
  │ │     │   💬 Args: [no args]
  │ │     │   👁️  Def: public
  │ │     │ └─ [6] ⚙️ FUNCTION: ERC20Upgradeable._getERC20Storage() (NodeID: 106)
  │ │     │     💬 Args: [no args]
  │ │     │     👁️  Def: private
  │ │     ├─ [5] ⚙️ FUNCTION: ERC4626Upgradeable.totalAssets() (NodeID: 107)
  │ │     │   💬 Args: [no args]
  │ │     │   👁️  Def: public
  │ │     │ └─ [6] ⚙️ FUNCTION: ERC4626Upgradeable.asset() (NodeID: 108)
  │ │     │     💬 Args: [no args]
  │ │     │     👁️  Def: public
  │ │     │   └─ [7] ⚙️ FUNCTION: ERC4626Upgradeable._getERC4626Storage() (NodeID: 109)
  │ │     │       💬 Args: [no args]
  │ │     │       👁️  Def: private
  │ │     ├─ [5] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 97)
  │ │     │   💬 Args: [unsignedRoundsUp(rounding) && (mulmod(x, y, denominator) > 0)]
  │ │     │   👁️  Def: internal
  │ │     │ └─ [6] ⚙️ FUNCTION: Math.unsignedRoundsUp(enum Math.Rounding) (NodeID: 98)
  │ │     │     💬 Args: [rounding]
  │ │     │     👁️  Def: internal
  │ │     └─ [5] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 99)
  │ │         💬 Args: [x, y, denominator]
  │ │         👁️  Def: internal
  │ │       ├─ [6] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 100)
  │ │       │   💬 Args: [x, y]
  │ │       │   👁️  Def: internal
  │ │       └─ [6] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 101)
  │ │           💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
  │ │           👁️  Def: internal
  │ │         └─ [7] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 102)
  │ │             💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
  │ │             👁️  Def: internal
  │ │           └─ [8] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 103)
  │ │               💬 Args: [condition]
  │ │               👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: BaseVault._deposit(address,address,uint256,uint256) (NodeID: 110)
  │     💬 Args: [fundingAccount_, receiver, firstDepositAmount_, shares]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: ERC4626Upgradeable._deposit(address,address,uint256,uint256) (NodeID: 111)
  │       💬 Args: [caller, receiver, assets, shares]
  │       👁️  Def: internal
  │     ├─ [4] ⚙️ FUNCTION: SafeERC20.safeTransferFrom(contract IERC20,address,address,uint256) (NodeID: 112)
  │     │   💬 Args: [IERC20(asset()), caller, address(this), assets]
  │     │   👁️  Def: internal
  │     │ ├─ [5] ⚙️ FUNCTION: ERC4626Upgradeable.asset() (NodeID: 114)
  │     │ │   💬 Args: [no args]
  │     │ │   👁️  Def: public
  │     │ │ └─ [6] ⚙️ FUNCTION: ERC4626Upgradeable._getERC4626Storage() (NodeID: 115)
  │     │ │     💬 Args: [no args]
  │     │ │     👁️  Def: private
  │     │ └─ [5] ⚙️ FUNCTION: SafeERC20._callOptionalReturn(contract IERC20,bytes) (NodeID: 113)
  │     │     💬 Args: [token, abi.encodeCall(token.transferFrom, (from, to, value))]
  │     │     👁️  Def: private
  │     └─ [4] ⚙️ FUNCTION: ERC20Upgradeable._mint(address,uint256) (NodeID: 116)
  │         💬 Args: [receiver, shares]
  │         👁️  Def: internal
  │       └─ [5] ⚙️ FUNCTION: ERC20Upgradeable._update(address,address,uint256) (NodeID: 117)
  │           💬 Args: [address(0), account, value]
  │           👁️  Def: internal
  │         └─ [6] ⚙️ FUNCTION: ERC20Upgradeable._getERC20Storage() (NodeID: 118)
  │             💬 Args: [no args]
  │             👁️  Def: private
