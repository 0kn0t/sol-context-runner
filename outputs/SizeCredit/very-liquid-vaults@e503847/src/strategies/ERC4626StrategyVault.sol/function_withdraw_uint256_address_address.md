...
┌─ [0] ⚙️ FUNCTION: ERC4626Upgradeable.withdraw(uint256,address,address) (NodeID: 0)
  ...
  │   │     👁️  Def: internal
  │   │   ├─ [5] ⚙️ FUNCTION: ERC4626StrategyVault.totalAssets() (NodeID: 14)
  │   │   │   💬 Args: [no args]
  │   │   │   👁️  Def: public
  ...
  │         💬 Args: [condition]
  │         👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ERC4626Upgradeable.previewWithdraw(uint256) (NodeID: 20)
  │   💬 Args: [assets]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: ERC4626Upgradeable._convertToShares(uint256,enum Math.Rounding) (NodeID: 21)
  ...
  │       👁️  Def: internal
  │     ├─ [4] ⚙️ FUNCTION: ERC4626Upgradeable._decimalsOffset() (NodeID: 30)
  │     │   💬 Args: [no args]
  │     │   👁️  Def: internal
  ...
  │     │     💬 Args: [no args]
  │     │     👁️  Def: private
  │     ├─ [4] ⚙️ FUNCTION: ERC4626StrategyVault.totalAssets() (NodeID: 33)
  │     │   💬 Args: [no args]
  │     │   👁️  Def: public
